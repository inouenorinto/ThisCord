...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.1/cropper.css" integrity="sha512-bs9fAcCAeaDfA4A+NiShWR886eClUcBtqhipoY5DM60Y1V3BbVQlabthUBal5bq8Z8nnxxiyb1wfGX2n76N1Mw==" crossorigin="anonymous" referrerpolicy="noreferrer" />
...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100;200;300;400;500;600;700;800;900&family=Open+Sans:wght@300;400;500;600;700;800&family=Poppins:wght@200;300;400;500;600;900&display=swap" rel="stylesheet">
...
<!---------------------------------- サーバー一覧(server-list) -------------------------------->
		<div class="server-scroll server-list">
			...
			<!-- サーバー作成ボタン -->
			<div class="server-list-item">
				<a class="plus_button" data-bs-toggle="modal" data-bs-target="#createServerModal"> 
				...
				<div class="channel-title-nav">
					<div class="flexbox">
						<div class="flex-item title-item">
							<i class="fa-solid fa-angle-down fa-xs"></i>
							<span class="channel-title">テキストチャンネル</span>
						</div>
						<div class="flex-item">
			...
			<div class="user-info">
				...
				<div class="d-flex align-items-end h-10 user-conf">
					<div class="user-field">
						<div id="user" ></div>
						<div class=".buttns">
							<button class="interface-item-i" id="microphone"><i class="fa-solid fa-microphone fa-sm"></i></button>
							<button class="interface-item-i"><i class="fa-solid fa-headphones fa-sm"></i></button>
							<button class="interface-item-i"><i class="fa-solid fa-gear fa-sm"></i></button>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="server-header" class="text-center server-header">
			<div class="channle-name">
				<div class="flexbox">
					...
					<div class="flex-item channel-title"><div id="channel"></div></div>
				</div>
			</div>
		</div>
